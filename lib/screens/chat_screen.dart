...
class _ChatScreenState extends State<ChatScreen> {
  ...
  bool _otherUserAllowsMeetup = false; // respects target user's privacy setting
  ...
  void _showCallLockedSnack() {
    ...
    if (_messagesFromMeCount < 3 && _messagesFromOtherCount < 3) {
      msg =
          'Both you and ${widget.otherUserName} need to send at least 3 messages each to unlock calling!';
      ...
      msg =
          'Wait for ${widget.otherUserName} to send $rem more message${rem > 1 ? 's' : ''} to unlock calling!';
    }
  ...
  Widget _buildMessageContent(
    ...
    if (msg.isSuperRequest) {
      return _buildSuperRequestBubble(msg, isMe);
    }
  ...
  Widget _buildSuperRequestBubble(ChatMessage msg, bool isMe) {
