...
class ProfileViewersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (currentUser == null) {
      return Scaffold(
        body: Center(
          child: Text(languageProvider.getString('signin_to_see_viewers')),
        ),
      );
    }
      ...
      sliver: SliverGrid(
        ...
        delegate: SliverChildBuilderDelegate((context, index) {
          ...
          final isUnlocked =
              ...
              (profileProvider.userProfile?.unlockedViewers.contains(
                    profile.uid,
                  ) ??
                  false);
          ...
          return GestureDetector(
            onTap: isUnlocked
                ? () => _showProfileDetails(context, profile, languageProvider)
                : () => _showUnlockDialog(context, profile, languageProvider),
            child: Container(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        try {
                          Navigator.pop(context);
                          await profileProvider.unlockViewer(profile.uid!);
                        } catch (e) {
                          if (context.mounted) {
